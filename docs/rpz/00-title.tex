...
% 		\centering
% 		\begin{signstabular}[0.7]{p{7.25cm} >{\centering\arraybackslash}p{4cm} >{\centering\arraybackslash}p{4cm}}
% 			Студент группы \textbf{ИУ7-83Б} & \uline{\mbox{\hspace*{4cm}}} & \uline{\hfill \textbf{Топорков П.А.} \hfill} \\
% 			& \scriptsize (Подпись, дата) & \scriptsize (И.О. Фамилия)
% 		\end{signstabular}
...
% 		\begin{signstabular}[0.7]{p{7.25cm} >{\centering\arraybackslash}p{4cm} >{\centering\arraybackslash}p{4cm}}
% 			Руководитель ВКР& \uline{\mbox{\hspace*{4cm}}} & \uline{\hfill \textbf{Терентьев Ю.И.} \hfill} \\
% 			& \scriptsize (Подпись, дата) & \scriptsize (И.О. Фамилия)
% 		\end{signstabular}
